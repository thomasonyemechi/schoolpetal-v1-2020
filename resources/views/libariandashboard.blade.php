          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">E-books
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Due Books</span>
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h5 class="card-title"><i class="fa far-pie-chart nav-icon"></i> Histories</h5>
                  ...
                  <div class="row">
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        ...
                        <span class="description-text">Book Category</span>
                      </div>
                      <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        ...
                        <span class="description-text">Active Readers</span>
                      </div>
                      <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
