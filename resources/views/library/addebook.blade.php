 ...
 ?>
        ...
        <div class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0 text-dark"> E-Library Management</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
          ...
          <section class="content">
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Add E-Book</h3><button class="btn btn-default btn-sm float-right" data-toggle="modal" data-target="#addcat">Add Book Category</button>
                    </div>
                       
                    <x-jet-validation-errors class="mb-4" />
                    <div class="card-body">
                    <p><form action="/AddBook" method="post" role="form" enctype="multipart/form-data">
                             @csrf     
                              <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              <div class="card card-secondary">
                <div class="card-header">
                  <h3 class="card-title">Recently Added E-Books</h3>
                </div>
            ...
            {{-- <div class="col-md-12 col-sm-12">
              <iframe src="bussiness/book/xlhs2loexdsntrjftg5y.pdf" frameborder="2" width="100%" height="700px"></iframe>
